class KleinzengenFilter:
	...
	def get_web_url(self)->str:
		try:
			...
			url = "+".join([x for x in [url, brand_param, self.transmission, self.fuel, model_id, year] if x is not None])
...
if __name__ == "__main__":
	filters = KleinzengenFilter(brand={"brand_id":"bmw", "model_id":"5er"},
								fuel="Autogas (LPG)",transmission="Автомат", price="1000-5000", city='Berlin')
